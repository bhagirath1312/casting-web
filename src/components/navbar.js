...
=======
        {/* Mobile Menu Button & Dark Mode Toggle (Always Visible) */}
...
=======
          ...
          >
            ...
            <NavItem text="About Us" sectionId="about-us" active={activeSection === "about-us"} onClick={scrollToSection} darkMode={darkMode} />
            <NavItem text="Services" sectionId="services" active={activeSection === "services"} onClick={scrollToSection} darkMode={darkMode} />
            <NavItem text="FAQ" sectionId="faq" active={activeSection === "faq"} onClick={scrollToSection} darkMode={darkMode} />
            <NavItem text="Contact" sectionId="contact" active={activeSection === "contact"} onClick={scrollToSection} darkMode={darkMode} />
>>>>>>> 9d719e0 (add dark mode functionlity)
          </motion.div>
        )}
      </AnimatePresence>
