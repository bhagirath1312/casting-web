...
<<<<<<< HEAD
       {/* ✅ About Us Section */}
<section className="py-20 px-6 text-center bg-neutral dark:bg-darkBg" id="about-us">
  <div className="max-w-4xl mx-auto">
    ...
    <p className="text-text dark:text-darkText mt-4 text-lg leading-relaxed">
      ...
      <spa> casting calls, auditions, and career-boosting opportunities</spa> 
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-4 text-lg leading-relaxed">
                Whether you're an aspiring actor, model, or voice-over artist, we ensure your skills get the exposure they deserve.
                Join us today and take the next step toward your dream career.
              </p>
            </div>
          </motion.div>
        </div>
...
=======
      ...
      <section id="testimonials" className="pt-16 px-6 text-center bg-neutral mb-4">
        <h2 className="text-3xl font-bold text-primary dark:text-dark-primary">What Our Users Say</h2>
        <div className="mt-8 max-w-4xl mx-auto h-32 relative overflow-hidden">
          <div className={`transition-opacity duration-500 transform ${fade ? "opacity-0 -translate-x-4" : "opacity-100 translate-x-0"}`}>
...
=======
      {/* ✅ Call to Action */}
      <section id="call-to-action" className="py-16 px-6 text-center bg-gradient-to-r from-primary to-accent text-white rounded-lg shadow-lg mx-4 md:mx-16 mt-4 mb-16">
>>>>>>> 9d719e0 (add dark mode functionlity)
        <h2 className="text-4xl font-bold">Ready to Get Started?</h2>
        <p className="mt-4 max-w-2xl mx-auto text-lg leading-relaxed">
          Take the next step in your career and join a thriving community of talent.
...
<<<<<<< HEAD
          <Link href="/signup" className="inline-block px-8 py-4 bg-white text-[#8E3F67] font-semibold text-lg rounded-lg shadow-md hover:bg-[#F4F0F9] hover:text-[#5B408C] transition-transform transform hover:scale-105">
=======
          <Link href="/signup" className="inline-block px-8 py-4 bg-white text-accent font-semibold text-lg rounded-lg shadow-md hover:bg-neutral hover:text-primary transition-transform transform hover:scale-105">
>>>>>>> 9d719e0 (add dark mode functionlity)
            Sign Up Now
          </Link>
        </div>
